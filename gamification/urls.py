...
from .views import TaskListView, UserTaskListView, PointsListView, PointsUserView, TaskUserView # LIST
...
urlpatterns = [
    path('task/', TaskUserView.as_view(), name='task_user'), 
    path('task/lista/', TaskListView.as_view(), name='task_list'), 
